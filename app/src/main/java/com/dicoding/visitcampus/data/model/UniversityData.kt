...
object UniversityData {
    val dummyUniversity = listOf(
        University(1,
            ...
            "cover_institut_teknologi_bandung",
            -6.89261334618102,
            107.610389453164,
            listOf(
            ...
            listOf(
                AlumnusProfile(1, "Joko Anwar", "Tahun Kelulusan 1999", "Sutradara",R.drawable.alumnus_photo),
                AlumnusProfile(2, "Ridwan Kamil", "Tahun Kelulusan 1995", "Gubernur Jawa Barat",R.drawable.alumnus_photo),
                AlumnusProfile(3, "Pandji Pragiwaksono", "Tahun Kelulusan 1997", "Stand Up Comedian",R.drawable.alumnus_photo)
            ),
            listOf(
        ...
        University(2,
            ...
            listOf(
                AlumnusProfile(4, "Muhammad Sapri Pamulu, Ph.D", "Fakultas Pokok Lulus 2005", "CEO at PT Indah Karya Persero (BUMN)", R.drawable.alumnus_photo),
            ),
            listOf(
                RegistrationPath(2,
